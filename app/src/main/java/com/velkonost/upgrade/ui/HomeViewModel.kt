...
class HomeViewModel @Inject constructor(
    ...
    fun setInterests(documentSnapshot: DocumentSnapshot) {
        ...
        relationshipInterestStart.selectedValue = documentSnapshot.get("4_start").toString().toFloat()
        ...
        financeInterestStart.selectedValue = documentSnapshot.get("6_start").toString().toFloat()
        ...
        environmentInterestStart.selectedValue = documentSnapshot.get("7_start").toString().toFloat()
        ...
        creationInterestStart.selectedValue = documentSnapshot.get("8_start").toString().toFloat()
